...
In order to publish the Gem bump the version in _this file_, commit, create a tag with the new version number, and finally push the commit and tag to the repo.
